...
router.all(`*`, (req, res, next) => {
  ...
  if (
    ...
    req.path !== "/admin/index" &&
    req.path !== `/admin/ajax_login`
  ) {
...
router.post(`/admin/ajax_art_single_update`, handler.singleUpdate);
router.get(`/admin/ajax_admin_updatepwd`, handler.updatepwd);
router.get(`/admin/ajax_admin_list`, handler.adminList);
